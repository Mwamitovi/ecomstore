...
def do_auth_capture(amount='0.00', card_num=None, exp_date=None, card_cvv=None):
    """ function that connects to the Authorize.Net with billing information.
    Returns a Python list containing the response parameters as sent back by the payment gateway.
    The first item in the response list is the response code;
    the 7th item is the uniquely identifying transaction ID
    """
    delimiter = '|'
    raw_params = {
